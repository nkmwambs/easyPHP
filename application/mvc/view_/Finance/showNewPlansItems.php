...
foreach($data[1] as $icpNewItem):
    echo "<tr><td>".Resources::a_href("Finance/pfSchedules/icpNo/$icpNewItem->icpNo/fy/$data[0]/",$icpNewItem->icpNo)."</td><td>$icpNewItem->cnt</td><td>".number_format($icpNewItem->Cost,2)."</td></tr>";
endforeach;
echo "</table>";
?>