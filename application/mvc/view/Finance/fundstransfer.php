...
echo "<tr><td style='font-weight:bold;'>Month From (End Month Date):</td><td><INPUT TYPE='text' id='monthfrom' name='monthfrom'/>".Resources::img("go.png",array("Title"=>"Go","onclick"=>'getfundsamount()'))."</td></tr>";
