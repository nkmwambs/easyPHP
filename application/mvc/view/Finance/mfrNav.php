...
if(strtotime($curSelect)===strtotime(date("F-Y"))){
	$reportingTime=date("d-m-Y");
}else{
	$reportingTime=date("t-m-Y",$data[1]);
}

    //echo strtotime(date("F-Y"))."<br>";
	//echo strtotime($curSelect);
...
echo "<tr><td colspan='2'>Total</td><td colspan='2' class='Totals'>".number_format($data[5],2)."</td></tr>";
