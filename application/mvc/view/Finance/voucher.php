                ...
                <tr>
                    ...
                    if($data['date_flag']==='0'){
		                  if ($data['months']<=9){
		                    ...
		                    <td><b>Date:</b></td><td><input type="text" id="TDate" class='dateSelector validate' onchange="calcVNumber();" name="TDate" style="width:95%;" value="" readonly="readOnly"/><input type='hidden' id="previousDate" value="<?php echo $data['maxRec']['TDate'];?>"/></td><td><b>Voucher Number</b></td><td><input type="text" id="VNumber" name="VNumber" style="width:95%;" value='' readonly="readOnly"/><input type="hidden" id="prevVNumber" value="<?php echo $data['maxRec']['VNumber'];?>"/></td>
		                    <?php
