...
echo Resources::a_href("Exams/viewKcse","[View K.C.S.E Results]");

echo "<hr>";
echo "<br>";

//echo "<button>View Results</button>";
echo "<button onclick='addNewKcseAc(\"tblAc\")'>Add Record</button>";
echo "<button id='deleteRow' style='display:none;' onclick='delRow(\"tblAc\")'>Remove Row</button>";
echo "<button onclick='submitKcseAc(\"frmShw\");'>Submit</button>";
...
echo "<tr><th colspan='18'>K.C.S.E Academic Results</th></tr>";
echo "<tr><th>Select</th><th>Cluster</th><th>ICP No.</th><th>Child No</th><th>Child Name</th><th>Date Of Birth</th><th>Gender</th><th>Index Number</th><th>English</th><th>Kiswahili</th><th>Mathematics</th><th>Chemistry</th><th>Biology</th><th>Physics</th><th>Grade</th><th>Academic Year</th></tr>";
