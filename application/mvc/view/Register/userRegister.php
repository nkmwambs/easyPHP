...
<table id="newuser">
    ...
    <tr><td>Email:</td><td><input type="text" id="email" name="uname" placeholder="Personal Email" onblur="validate(this);"/></td></tr>
    <tr><td>Role:</td><td><select name="userlevel"><option value=''>Select Role</option><option value="40">ICP Staff</option><option value="50">CKE Staff</option></select></td></tr>
