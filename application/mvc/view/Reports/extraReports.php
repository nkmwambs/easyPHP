...
//Query Fieldset
echo "<form id='qryfld'>";
echo "<fieldset style='width:30%;border:2px orange solid;float:left;margin-bottom:60px;'>";
...
echo "<fieldset id='conditions' style='border:2px orange solid;float:left;min-width:490px;min-height:50px;;margin-bottom:60px;'>";
