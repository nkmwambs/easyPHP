<?php
echo "You currently using  <b>".$data."'s</b> user profile. Your original Profile is <span onclick='getUser(\"".Resources::session()->username_backup."\");'><b>".Resources::session()->userfirstname_backup."</b></span><br><br>";
...
echo Resources::a_href("","[Search Users]",array("onclick"=>'javascript:void window.open("https://www.compassionkenya.com/easyPHP/mvc/Welcome/userpop","searchusers","width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0");return FALSE'));
