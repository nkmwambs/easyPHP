...
<table id="tbl_BioData" class='studentdraft' style="border:1px solid orange;max-width:750px;">
    ...
    <tr><th colspan="3">&nbsp;</th></tr>
        ...
        <tr>
            ...
            <td> Nationality: <input  class="mandatory" type="text" onchange='clearHighlight(this);' id="nationality" name="nationality" title="Nationality" placeholder="Nationality"/></td>
