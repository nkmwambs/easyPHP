...
<table style='border:2px orange solid;'>
    <caption><?php echo Resources::img("userprofile.png");?> User Profile</caption>
    <tr><th align='left'>Field</th><th align='left'>Value</th></tr>
<?php

$th_array = array("username"=>array("User Name","No"),"fname"=>array("First Name","Yes"),"lname"=>array("Last Name","Yes"),"email"=>array("Email","Yes"),"admin"=>array("Administrator","No"),"auth"=>array("Aunthenticated","No"),"userlevel"=>array("User Level","No"));
